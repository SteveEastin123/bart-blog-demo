...
require_once EHRMAN_DISCOVERY_PLUGIN_DIR . 'includes/class-post-ingestion-settings.php';
require_once EHRMAN_DISCOVERY_PLUGIN_DIR . 'includes/class-post-ingestion-validator.php';
require_once EHRMAN_DISCOVERY_PLUGIN_DIR . 'includes/class-post-ingestion-analyzer.php';
