		...
		wp_localize_script(
			...
			array(
				...
				'strings'        => array(
					...
					'directAnswers'   => __( 'Directly answers the question', 'ehrman-blog-discovery' ),
					'stronglyRelated' => __( 'Strongly related', 'ehrman-blog-discovery' ),
					'supporting'      => __( 'Supporting background', 'ehrman-blog-discovery' ),
				),
			)
		);
	}
