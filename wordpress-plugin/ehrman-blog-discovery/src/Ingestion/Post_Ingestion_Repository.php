...
/**
 * Stores ingestion drafts and workflow state, and exposes approved vocabulary.
 *
...
final class Post_Ingestion_Repository {
	/**
	 * Approved topic and keyword vocabulary reader.
	 *
	 * @var Post_Ingestion_Vocabulary_Reader
	 */
	private Post_Ingestion_Vocabulary_Reader $vocabulary_reader;

	/**
	 * Creates the ingestion repository.
	 *
	 * @param Post_Ingestion_Vocabulary_Reader|null $vocabulary_reader Optional vocabulary reader.
	 */
	public function __construct( ?Post_Ingestion_Vocabulary_Reader $vocabulary_reader = null ) {
		$this->vocabulary_reader = $vocabulary_reader ?? new Post_Ingestion_Vocabulary_Reader();
	}
	...
	public function vocabulary(): array {
		return $this->vocabulary_reader->vocabulary();
	}
	...
	public function vocabulary_hash( array $taxonomy ): string {
		return $this->vocabulary_reader->vocabulary_hash( $taxonomy );
	}
