<?php
/**
 * Post-ingestion proposal validation and normalization.
 *
...
/**
 * Validates and canonicalizes AI and administrator proposals.
 *
 ...
 */
final class Post_Ingestion_Proposal_Validator {
	...
	/**
	 * Validates and canonicalizes a proposal.
	 *
	 ...
	 */
	public function validate( array $proposal, array $vocabulary, bool $allow_held, bool $require_rationales = false, string $post_title = '' ) {
