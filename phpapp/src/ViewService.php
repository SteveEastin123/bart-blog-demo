...
function ehrman_keyword_panel(
    ...
    return '<form class="keyword-search-panel" action="' . ehrman_html($formAction)
        ...
        . 'Combine multiple terms to narrow your results.</p>'
        ...
        . '<label class="sort-choice"><input type="radio" name="suggestion_order" value="keywords-first"><span>Keywords first</span></label></div>'
        . '<div class="keyword-grid"><div class="keyword-slot-grid" data-keyword-chip-list>'
        . implode('', $chips) . $entry . implode('', $emptySlots) . '</div></div>'
        . '<div class="sort-row post-sort-row"><span class="sort-label">Sort by</span>' . implode('', $sortOptions) . '</div>'
