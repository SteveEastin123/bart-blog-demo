...
REPLACE = {
    ...
    "Early Christian Apocryphal": "Christian Apocrypha",
    ...
    "Wrede": "Wilhelm Wrede",
    "Yale Convocation": "Yale University",
...
REMOVE_BY_POST = {
    "1981": {"Ancient Jewish Afterlife Beliefs"},
    "2517": {"Ancient Jewish Afterlife Beliefs", "Purgatory"},
    "2654": {"Social Justice"},
    "4841": {"Socialism"},
    "8503": {"Biblical Numerology"},
    "9252": {"Book Projects"},
    "13404": {"Scribal Changes"},
    "14930": {"Problem of Evil"},
    "21778": {"Biblical Numerology"},
    "25202": {"Herodias"},
    "25333": {"Burial of Jesus"},
...
SOURCE_MAX_COUNTS = {
    ...
    "Historical Christianity": 3,
    "P46": 2,
    "UNC": 2,
    "Early Christian Apocryphal": 3,
    "Faith Transitions": 2,
    "Gods Problem": 2,
    "Greek Bible": 2,
