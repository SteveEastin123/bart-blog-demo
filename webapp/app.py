...
def home_page() -> bytes:
    ...
    <section class="site-home">
      ...
      <section class="site-demo-note" aria-label="Demo description">
        ...
        <p class="site-demo-version">Version 1.0 Blog Search Demo | {pluralize(stats['posts'], 'post')} | {pluralize(stats['categories'], 'category', 'categories')} | {pluralize(stats['themes'], 'theme')} | {pluralize(stats['keywords'], 'keyword')}</p>
      </section>
    </section>
    """
